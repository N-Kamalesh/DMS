...
export default function Signup() {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      const response = await fetch('http://10.16.49.209:8080/api/auth/register', {
        method: 'POST',
        headers: {
          ...
          <ScrollView style={{ marginTop: 30, paddingTop: StatusBar.currentHeight }}>
            <View className="flex items-center mx-4 space-y-4">
              ...
              <View className="bg-black/5 p-5 rounded-2xl w-full mb-3">
                ...
                />
                {errors.aadhar && <Text className="text-red-500">{errors.aadhar.message}</Text>}
              </View>
              ...
              <View className="bg-black/5 p-5 rounded-2xl w-full mb-3">
                ...
                />
                {errors.mobile && <Text className="text-red-500">{errors.mobile.message}</Text>}
              </View>
